...
class ZCRMOrganization
{
     ...
     *
     * @return bool true if google apps is enabled  otherwise false
     */
     ...
     *
     * @param bool $gapps_enabled true to enable the google apps otherwise false
     */
     ...
     *
     * @return bool true if paid account otherwise false
     */
     ...
     *
     * @param bool $paid true to enable the paid account otherwise false
     */

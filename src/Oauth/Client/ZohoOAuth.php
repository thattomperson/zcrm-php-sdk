...
class ZohoOAuth
{
    ...
    {
        $config_keys = [ZohoOAuthConstants::CLIENT_ID, ZohoOAuthConstants::CLIENT_SECRET, ZohoOAuthConstants::REDIRECT_URL, ZohoOAuthConstants::ACCESS_TYPE, ZohoOAuthConstants::PERSISTENCE_HANDLER_CLASS, ZohoOAuthConstants::IAM_URL, ZohoOAuthConstants::TOKEN_PERSISTENCE_PATH, ZohoOAuthConstants::DATABASE_PORT, ZohoOAuthConstants::DATABASE_PASSWORD, ZohoOAuthConstants::DATABASE_USERNAME];
    ...
    {
        try {
            return self::getConfigValue('token_persistence_path') != '' ? new ZohoOAuthPersistenceByFile() : new ZohoOAuthPersistenceHandler();
        } catch (Exception $ex) {
